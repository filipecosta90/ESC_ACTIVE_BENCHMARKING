...
Ora, para o caso do filesystem UFS podemos considerar a precisão da ferramenta vs ZFS é superior. Tal será certamente devido à complexidade acrescida e otimização presentes no filesystem ZFS. Realizemos o mesmo teste agora para o filesystem UFS. Denote que, este último filesystem lida com uma tecnologia de armazenamento física diferente das até agora utilizadas. Iremos realizar o teste para o path 
